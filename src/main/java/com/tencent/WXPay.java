...
public class WXPay {
    ...
    /**
     * 统一下单
     * @param getOrderReqData
     * @return
     * @throws Exception
     */
    public static String requestGetOrderService(GetOrderReqData getOrderReqData) throws Exception {
        //checkIsSignValidFromResponseString
        return new GetOrderService().request(getOrderReqData);
    }
